...
const ConstructorPage = () => {
    ...
    //TODO исправить все баги: авторизация, токен, увеличивается количество булок при замене булки, нет прелоудера при повторном заказе
    //TODO добавить в конструктор пустую булку при добавлении
    // TODO добавить контур перетаскиваемой булки
